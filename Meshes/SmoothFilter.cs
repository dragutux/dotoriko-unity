...
/*
    Source http://wiki.unity3d.com/index.php/MeshSmoother
...
namespace DotOriko.Meshes {
    public sealed class SmoothFilter {
        ...
        private static Vector3[] LaplacianFilter(Vector3[] sv, int[] t) {
        ...
        /*
            ...
            Where sv - original points
                    ...
                    beta  [0..1] e.g. > 0.5
        */
        private static Vector3[] HCFilter(Vector3[] sv, Vector3[] pv, int[] t, float alpha, float beta) {
            Vector3[] wv = new Vector3[sv.Length];
